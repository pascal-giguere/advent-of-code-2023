...
describe("q1", () => {
  describe("Part 1", () => {
    it("calculates the sum of calibration values from a simple input", () => {
      expect(calculateCalibrationValueSum(SIMPLE_INPUT)).toEqual(142);
    });

    it("calculates the sum of calibration values from a complex input", () => {
      expect(calculateCalibrationValueSum(COMPLEX_INPUT)).toEqual(53194);
    });
  });

  describe("Part 2", () => {
    it("calculates the sum of calibration values from a simple input - parse numbers as words", () => {
      expect(calculateCalibrationValueSum(SIMPLE2_INPUT, { parseNumbersAsWords: true })).toEqual(281);
    });

    it("calculates the sum of calibration values from a complex input - parse numbers as words", () => {
