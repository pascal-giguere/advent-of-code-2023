...
import { calculateMinimumSetPowersSum, calculatePossibleGamesSum } from "../../src/q2/index.js";
...
describe("q2", () => {
  describe("Part 1", () => {
    it("calculates the sum of possible games from a simple input",  () => {
      expect(calculatePossibleGamesSum(SIMPLE_INPUT)).toEqual(8);
    });

    it("calculates the sum of possible games from a complex input", () => {
      expect(calculatePossibleGamesSum(COMPLEX_INPUT)).toEqual(2204);
    });
  });

  describe("Part 2", () => {
    it("calculates the sum of powers of minimum sets from a simple input", () => {
      expect(calculateMinimumSetPowersSum(SIMPLE_INPUT)).toEqual(2286);
    });

    it("calculates the sum of powers of minimum sets from a complex input", () => {
